//
//  WebtoonRandomListCell.swift
//  TooniTooni
//
//  Created by buzz on 2021/06/06.
//

import UIKit

class WebtoonRandomListCell: UITableViewCell {
...
extension WebtoonRandomListCell {
...
extension WebtoonRandomListCell: UICollectionViewDelegate, UICollectionViewDataSource {
